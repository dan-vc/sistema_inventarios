...
@section('content')
  <!-- Start block -->
  <section class=" p-3 sm:p-5 antialiased mt-[2rem]">
          ...
          <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
              <tr>
                ...
                <th scope="col" class="p-4">Código de Barras</th>
                <th scope="col" class="p-4">Peso</th>
                ...
                <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                  <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    <div class="flex items-center mr-3">
                      <a class="underline" href="{{ route('web.products.show', $inventory->product) }}">
                        {{ $inventory->product->name }}
                      </a>
                    </div>
                  </th>
                  <td class="px-4 py-3">
                    <span class="text-xs font-medium px-2 py-0.5 rounded line-clamp-3">
                      {{ $inventory->product->description }}</span>
                  </td>
                  ...
                  <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    <div class="flex items-center">
                      ...
                      S/{{ $inventory->product->price }}
                    </div>
                  </td>
                  <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    {{ $inventory->product->status }}</td>
                  <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                  ...
                  <td class="px-4 py-3">
                    <span
                      class="bg-primary-100 text-primary-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">{{ $inventory->product->marca }}</span>
                  </td>
                  <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    <div class="flex items-center space-x-4">

                      {{-- Editar --}}
                      <a href="{{ route('web.products.edit', $inventory->product) }}"
                      ...
                      {{-- Eliminar --}}
                      <form action="{{ route('web.products.destroy', $inventory->product) }}" method="POST"
